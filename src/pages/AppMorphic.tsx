      ...
      >
        ...
        >
          ...
          <p
            ...
            itemProp="jobTitle"
          >
            {role} | React & TypeScript Expert | Frontend Architect
          </p>
        ...
        <section className="mb-1.5 pb-1.5 border-b relative">
          ...
          <p className="text-sm leading-tight text-black">
            ...
            Talview, with a proven track record of delivering{" "}
            <strong>enterprise-grade applications</strong> and leading{" "}
            <strong>frontend architecture initiatives</strong>. Skilled in{" "}
            <strong>component-driven development</strong>,{" "}
            <strong>state management</strong>, <strong>API integration</strong>,
            and <strong>performance optimization</strong>. Strong expertise in{" "}
            <strong>React ecosystem</strong>, <strong>TypeScript</strong>,{" "}
            <strong>GraphQL/REST APIs</strong>, and{" "}
            <strong>modern build tools</strong>. Passionate about writing{" "}
            <strong>clean, maintainable code</strong> and following{" "}
            <strong>best practices</strong> in frontend development.
          </p>
        </section>
          ...
          <ul className="text-sm space-y-0.5 text-black">
            ...
            <li className="flex items-start">
              <div>
                ...
                <span className="mx-2">|</span>
                <span itemProp="itemListElement">
                  GraphQL / Apollo Client / Hasura / RESTful API / Axios / Fetch
                  API
                </span>
              </div>
            </li>
            <li className="flex items-start">
              <div>
                ...
                <span className="mx-2">|</span>
                <span itemProp="itemListElement">
                  TailwindCSS / Material UI / Shadcn/ui / Semantic UI / Radix UI
            ...
            <li className="flex items-start">
              <div>
                ...
                <span className="mx-2">|</span>
                <span itemProp="itemListElement">
                  CI/CD / GitHub Actions / Docker / Git / Sentry
                </span>
              </div>
            </li>
            <li className="flex items-start">
              <div>
                ...
                <span>
                  ...
                  Optimization / Code Review / Agile Methodologies
                </span>
              </div>
            </li>
          </ul>
        ...
        <section className="mb-1.5 pb-1.5 border-b">
          ...
          >
            ...
            <div className="mb-1">
              ...
              <ul className="list-disc list-inside text-sm space-y-0.5 text-black">
                <li>
                  ...
                  <strong>React-based applications</strong> using{" "}
                  <strong>TypeScript</strong>, following{" "}
                  <strong>best practices</strong> and{" "}
                  <strong>component-driven architecture</strong>.
                </li>
                <li>
                  Built <strong>reusable component libraries</strong> and{" "}
                  <strong>design systems</strong>, improving code reusability
                  and development efficiency.
                </li>
                <li>
                  Implemented <strong>responsive designs</strong> and ensured{" "}
                  <strong>cross-browser compatibility</strong> across modern
                  browsers.
                </li>
                <li>
                  Integrated <strong>RESTful APIs</strong> and{" "}
                  <strong>GraphQL endpoints</strong> using{" "}
                  <strong>Apollo Client</strong> and <strong>Axios</strong>.
                </li>
              </ul>
            </div>
            ...
            <div className="mb-1">
              ...
              <ul className="list-disc list-inside text-sm space-y-0.5 text-black">
                <li>
                  Implemented <strong>state management solutions</strong> using{" "}
                  <strong>Redux</strong>, <strong>Redux-Saga</strong>, and{" "}
                  <strong>Context API</strong> for complex application state.
                </li>
                <li>
                  Optimized application performance through{" "}
                  <strong>code splitting</strong>, <strong>lazy loading</strong>
                  , and <strong>bundle optimization</strong>, achieving{" "}
                  <strong>40% reduction in load time</strong>.
                </li>
                <li>
                  Wrote comprehensive <strong>unit tests</strong> and{" "}
                  <strong>integration tests</strong> using <strong>Jest</strong>{" "}
                  and <strong>React Testing Library</strong>, maintaining{" "}
            ...
            <div className="mb-1">
              ...
              <ul className="list-disc list-inside text-sm space-y-0.5 text-black">
                <li>
                  ...
                  <strong>designers</strong>, and{" "}
                  <strong>backend engineers</strong> to deliver high-quality
                  features.
                </li>
                <li>
                  Participated in <strong>code reviews</strong> and maintained{" "}
                  <strong>coding standards</strong> to ensure code quality.
                </li>
                <li>
                  Worked in <strong>Agile/Scrum</strong> environment,
                  participating in <strong>sprint planning</strong>,{" "}
                  <strong>daily standups</strong>, and{" "}
