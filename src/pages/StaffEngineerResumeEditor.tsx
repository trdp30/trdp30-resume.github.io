...
export const StaffEngineerResumeEditor = () => {
      ...
      >
        ...
        <header className="mb-6" itemScope itemType="https://schema.org/Person">
          ...
          <p className="text-base text-gray-600 mb-3" itemProp="jobTitle">
            Software Engineer — Hands-On Full-Stack &amp; AI-Based Application
            Development
          </p>
        ...
        <section className="mb-7">
          <p className="text-[15px] leading-relaxed text-gray-700">
            ...
            AI. Staff Frontend Engineer at Talview and founder &amp; architect
            of <strong className="text-gray-900">LocalityAI</strong>{" "}
            (Veerluit), hands-on across the stack from React UIs and React
            Native to MCP servers, agentic LLM backends, and GraphQL platforms.
          </p>
        </section>
        ...
        <section className="mb-7">
          ...
          <div className="text-sm text-gray-700 space-y-1.5">
            <p>
              ...
              &nbsp;&nbsp;BlockNote · ProseMirror · EditorJS · custom blocks
              &amp; plugins · collaborative editing · Radix UI · Shadcn/ui ·
              Storybook
            </p>
            <p>
        ...
        <section className="mb-7">
          ...
          <ul className="space-y-2 text-[15px] leading-snug text-gray-700">
            <li className="flex gap-3">
              ...
              <span>
                Built the <strong className="text-gray-900">content creator</strong>{" "}
                on <strong className="text-gray-900">BlockNote</strong>,{" "}
                <strong className="text-gray-900">ProseMirror</strong>, and{" "}
                <strong className="text-gray-900">EditorJS</strong> — Google Docs
                / Notion-style rich text editing with secure file upload and
                asset management.
              </span>
            </li>
            <li className="flex gap-3">
            ...
            <li className="flex gap-3">
              ...
              <span>
                ...
                on, and porting the EditorJS content model across without data
                loss.
              </span>
            </li>
            <li className="flex gap-3">
            ...
            <li className="flex gap-3">
              ...
              <span>
                ...
                as MCP tools so Claude answers grounded, in-context questions
                over live data.
              </span>
            </li>
            <li className="flex gap-3">
              <span className="text-gray-300 select-none">—</span>
              <span>
                Built accessible, reusable component libraries with Radix UI,
                Shadcn/ui, and Storybook, speeding feature delivery{" "}
            ...
            <li className="flex gap-3">
              ...
              <span>
                ...
                and Cypress — <strong className="text-gray-900">85%+</strong>{" "}
                coverage and <strong className="text-gray-900">70%</strong> fewer
                production bugs.
              </span>
            </li>
            <li className="flex gap-3">
              <span className="text-gray-300 select-none">—</span>
              <span>
                Wired AI dev tools (Cursor, Claude Code, Codex) into the workflow
                with agentic + manual code review —{" "}
            ...
            <li className="flex gap-3">
              <span className="text-gray-300 select-none">—</span>
              <span>
                Mentor engineers through standards and reviews, and partner
                across design, product, sales, customer success, and backend.
              </span>
            </li>
            <li className="flex gap-3">
              <span className="text-gray-300 select-none">—</span>
          ...
          {/* LocalityAI */}
          <div className="mt-5 flex items-baseline justify-between mb-1">
            <h3 className="text-lg font-semibold text-gray-900">
              <a
          ...
          <ul className="space-y-2 text-[15px] leading-snug text-gray-700">
            <li className="flex gap-3">
              <span className="text-gray-300 select-none">—</span>
              <span>
                Built an <strong className="text-gray-900">MCP server</strong>{" "}
                that works with any MCP client — Claude Desktop/Web, ChatGPT,
                Gemini — plus an agentic chat server with RAG, so an LLM can
                search, book, and answer questions over live data.
              </span>
            </li>
            <li className="flex gap-3">
              <span className="text-gray-300 select-none">—</span>
            ...
            <li className="flex gap-3">
              <span className="text-gray-300 select-none">—</span>
              <span>
                Shipped <strong className="text-gray-900">10+ services</strong>{" "}
                on Cloud Run — auth, payments, commissions, feature flags — plus
                a React Native app and a Module Federation web app.
              </span>
            </li>
          </ul>
        </section>
...
export default StaffEngineerResumeEditor;
